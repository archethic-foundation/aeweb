...
mixin _$UnpublishWebsiteFormState {
  ...
  /// Create a copy of UnpublishWebsiteFormState
...
/// @nodoc
abstract class $UnpublishWebsiteFormStateCopyWith<$Res> {
  factory $UnpublishWebsiteFormStateCopyWith(UnpublishWebsiteFormState value,
          $Res Function(UnpublishWebsiteFormState) then) =
...
/// @nodoc
class _$UnpublishWebsiteFormStateCopyWithImpl<$Res,
        $Val extends UnpublishWebsiteFormState>
    implements $UnpublishWebsiteFormStateCopyWith<$Res> {
  _$UnpublishWebsiteFormStateCopyWithImpl(this._value, this._then);
