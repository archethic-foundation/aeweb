...
import 'package:aeweb/ui/views/add_website.dart/layouts/components/add_website_form_sheet.dart';
...
class AddWebsiteSheet extends ConsumerWidget {
  ...
  List<StepperData> getStepperDatas(BuildContext context) {
    return <StepperData>[
      ...
      StepperData(
        title: StepperText(
          'Creation of the reference transactions',
          textStyle: Theme.of(context).textTheme.labelLarge,
        ),
      ),
      StepperData(
      ...
      StepperData(
        title: StepperText(
          'Creation of the transfer transactions',
          textStyle: Theme.of(context).textTheme.labelLarge,
        ),
